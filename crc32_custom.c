...
//*  int (*hash)(char *in_buf, int in_len, char *out_buf, int out_len)
...
int crc32_hash (char *in_buf, int in_len, char *out_buf, int out_len){
    ...
    crc32_result = Crc32_ComputeBuf(crc32_result, in_buf, in_len);
    memcpy(out_buf, &crc32_result, sizeof(crc32_result));
    return 0;
}
